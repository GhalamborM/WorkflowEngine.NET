...
namespace OptimaJet.Workflow.Oracle
{
    public class OracleProvider : IWorkflowProvider, IMigratable
    {
        ...
        private async Task SaveParameterBatchAsync(PersistenceParametersBatch batch)
        {
            ...
            await using OracleConnection connection = OpenConnection();
            ...
            ProcessInstancePersistenceEntity persistedParameter)
        {
            ...
            {
                result = ParameterDefinition.CreateFromPersistence(parameterDefinition, ParametersSerializer.Deserialize(persistedParameter.Value,
