...
INSERT IGNORE INTO `Roles`(`Id`, `Name`) VALUES (UUID_TO_BIN('8d378ebe-0666-46b3-b7ab-1a52480fd12a', false), 'Big Boss');
INSERT IGNORE INTO `Roles`(`Id`, `Name`) VALUES (UUID_TO_BIN('412174c2-0490-4101-a7b3-830de90bcaa0', false), 'Accountant');
INSERT IGNORE INTO `Roles`(`Id`, `Name`) VALUES (UUID_TO_BIN('71fffb5b-b707-4b3c-951c-c37fdfcc8dfb', false), 'User');

INSERT IGNORE INTO `StructDivision`(`Id`, `Name`, `ParentId`) VALUES (UUID_TO_BIN('f6e34bdf-b769-42dd-a2be-fee67faf9045', false), 'Head Group', NULL);
INSERT IGNORE INTO `StructDivision`(`Id`, `Name`, `ParentId`) VALUES (UUID_TO_BIN('b14f5d81-5b0d-4acc-92b8-27cbbe39086b', false), 'Group 1', UUID_TO_BIN('f6e34bdf-b769-42dd-a2be-fee67faf9045', false));
INSERT IGNORE INTO `StructDivision`(`Id`, `Name`, `ParentId`) VALUES (UUID_TO_BIN('7e9fd972-c775-4c6b-9d91-47e9397bd2e6', false), 'Group 1.1', UUID_TO_BIN('b14f5d81-5b0d-4acc-92b8-27cbbe39086b', false));
INSERT IGNORE INTO `StructDivision`(`Id`, `Name`, `ParentId`) VALUES (UUID_TO_BIN('dc195a4f-46f9-41b2-80d2-77ff9c6269b7', false), 'Group 1.2', UUID_TO_BIN('b14f5d81-5b0d-4acc-92b8-27cbbe39086b', false));
INSERT IGNORE INTO `StructDivision`(`Id`, `Name`, `ParentId`) VALUES (UUID_TO_BIN('72d461b2-234b-40d6-b410-b261964ba291', false), 'Group 2', UUID_TO_BIN('f6e34bdf-b769-42dd-a2be-fee67faf9045', false));
INSERT IGNORE INTO `StructDivision`(`Id`, `Name`, `ParentId`) VALUES (UUID_TO_BIN('c5dcc148-9c0c-45c4-8a68-901d99a26184', false), 'Group 2.2', UUID_TO_BIN('72d461b2-234b-40d6-b410-b261964ba291', false));
INSERT IGNORE INTO `StructDivision`(`Id`, `Name`, `ParentId`) VALUES (UUID_TO_BIN('bc21a482-28e7-4951-8177-e57813a70fc5', false), 'Group 2.1', UUID_TO_BIN('72d461b2-234b-40d6-b410-b261964ba291', false));


INSERT IGNORE INTO `Employee`(`Id`, `Name`, `StructDivisionId`, `IsHead`) VALUES (UUID_TO_BIN('81537e21-91c5-4811-a546-2dddff6bf409', false), 'Silviya', UUID_TO_BIN('f6e34bdf-b769-42dd-a2be-fee67faf9045', false), 1);
INSERT IGNORE INTO `Employee`(`Id`, `Name`, `StructDivisionId`, `IsHead`) VALUES (UUID_TO_BIN('b0e6fd4c-2db9-4bb6-a62e-68b6b8999905', false), 'Margo', UUID_TO_BIN('dc195a4f-46f9-41b2-80d2-77ff9c6269b7', false), 0);
INSERT IGNORE INTO `Employee`(`Id`, `Name`, `StructDivisionId`, `IsHead`) VALUES (UUID_TO_BIN('deb579f9-991c-4db9-a17d-bb1eccf2842c', false), 'Max', UUID_TO_BIN('b14f5d81-5b0d-4acc-92b8-27cbbe39086b', false), 1);
INSERT IGNORE INTO `Employee`(`Id`, `Name`, `StructDivisionId`, `IsHead`) VALUES (UUID_TO_BIN('91f2b471-4a96-4ab7-a41a-ea4293703d16', false), 'John', UUID_TO_BIN('7e9fd972-c775-4c6b-9d91-47e9397bd2e6', false), 1);
INSERT IGNORE INTO `Employee`(`Id`, `Name`, `StructDivisionId`, `IsHead`) VALUES (UUID_TO_BIN('e41b48e3-c03d-484f-8764-1711248c4f8a', false), 'Maria', UUID_TO_BIN('c5dcc148-9c0c-45c4-8a68-901d99a26184', false), 0);
INSERT IGNORE INTO `Employee`(`Id`, `Name`, `StructDivisionId`, `IsHead`) VALUES (UUID_TO_BIN('bbe686f8-8736-48a7-a886-2da25567f978', false), 'Mark', UUID_TO_BIN('7e9fd972-c775-4c6b-9d91-47e9397bd2e6', false), 0);

INSERT IGNORE INTO `EmployeeRole`(`EmployeeId`, `RoleId`) VALUES (UUID_TO_BIN('e41b48e3-c03d-484f-8764-1711248c4f8a', false), UUID_TO_BIN('412174c2-0490-4101-a7b3-830de90bcaa0', false));
INSERT IGNORE INTO `EmployeeRole`(`EmployeeId`, `RoleId`) VALUES (UUID_TO_BIN('e41b48e3-c03d-484f-8764-1711248c4f8a', false), UUID_TO_BIN('71fffb5b-b707-4b3c-951c-c37fdfcc8dfb', false));
INSERT IGNORE INTO `EmployeeRole`(`EmployeeId`, `RoleId`) VALUES (UUID_TO_BIN('bbe686f8-8736-48a7-a886-2da25567f978', false), UUID_TO_BIN('71fffb5b-b707-4b3c-951c-c37fdfcc8dfb', false));
INSERT IGNORE INTO `EmployeeRole`(`EmployeeId`, `RoleId`) VALUES (UUID_TO_BIN('81537e21-91c5-4811-a546-2dddff6bf409', false), UUID_TO_BIN('8d378ebe-0666-46b3-b7ab-1a52480fd12a', false));
INSERT IGNORE INTO `EmployeeRole`(`EmployeeId`, `RoleId`) VALUES (UUID_TO_BIN('81537e21-91c5-4811-a546-2dddff6bf409', false), UUID_TO_BIN('71fffb5b-b707-4b3c-951c-c37fdfcc8dfb', false));
INSERT IGNORE INTO `EmployeeRole`(`EmployeeId`, `RoleId`) VALUES (UUID_TO_BIN('b0e6fd4c-2db9-4bb6-a62e-68b6b8999905', false), UUID_TO_BIN('71fffb5b-b707-4b3c-951c-c37fdfcc8dfb', false));
